...
function Home() {
  ...
  return (
    ...
    <section
      class="flex items-center w-full justify-center h-screen mb-0 bg-fixed bg-center bg-cover bg-main-page"
    >
      <div
        class="p-5 lg:text-main-title md:text-7xl text-6xl text-stone-300 rounded-md bg-primary capitalize font-title opacity-90"
      >
        CONTUSO
      </div>
    </section>
    <div class="w-auto bg-primary p-10">
      <div class="max-w-lg m-auto">
        <h1
          class="text-5xl text-center ml-0 font-title uppercase mb-4 text-stone-300"
        >
    ...
    >
      <p
        class="p-5 lg:text-2xl text-lg text-stone-300 bg-primary bg-opacity-80 rounded-xl font-title text-center shadow-2xl"
      >
        "Contuso provides the most reliable car parts we have ever seen. We recommend Contuso to anyone who wants the best quiality"<br />
        <b>-<i>Top Gear Magazine</i></b>
      </p>
    </div>
    <section id="products" class="flex flex-col items-center justify-center bg-primary">      
      <h1 className="text-5xl font-bold font-title p-8 text-stone-300 uppercase">Our Products</h1>
      <br></br>
